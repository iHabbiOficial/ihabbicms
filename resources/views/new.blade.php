...
<body class="bg-primary">
    @include('pages.guest.header')

    @include('pages.guest.section-one')

    @include('pages.guest.section-two')

    @include('pages.guest.footer')

    @include('pages.guest.modal-register')
