...
@php($boxes = ['Equipe iHabbi', 'Inscrições'])
@php($icons = ['hotel', 'comment'])
@php($descs = ['Sobre a equipe iHabbi', 'Vagas na equipe?'])
@php($contents = [
    'A equipe de funcionários do iHabbi é uma grande família competente, cada membro da equipe tem uma função e deveres diferentes a cumprir.', 
    'De vez em quando, vagas para a equipe podem ser abertas. Assim que o fizerem, sempre nos certificamos de postar uma notícia explicando todo o processo'
])
