...
<div @class([
    ...
    @forelse ($onlineFriends as $onlineFriend)
        ...
        >
            <div class="w-full h-full rounded-full bg-center bg-no-repeat" style="background-image: url('{{ getSetting('figure_imager') . $onlineFriend->look }}&direction=4&head_direction=4&size=m&gesture=sml&action=std,drk=1')"></div>
